...
Please note that the the code realted to phasechange simualation (Biomass pyrolysis and combustion) requries integration with the [OpenSMOKE++ framework](https://www.opensmoke.polimi.it/).
